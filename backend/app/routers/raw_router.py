...
from models.raw_model import RawDeleteResponseModel, RawDeleteResponseModelObject, RawGetModel, RawGetResponseModel, RawGetResponseModelObject, RawStoreModel, RawDeleteModel, RawStoreResponseModel, RawStoreResponseModelObject
router = APIRouter()

# Store raw
@router.post('/store', response_model=RawStoreResponseModel, status_code=StatusCode.CREATED.value)
...
# Get raw
@router.post('/get', response_model=RawGetResponseModel, status_code=StatusCode.OK.value)
...
# Delete raw
@router.delete('/delete', response_model=RawDeleteResponseModel, status_code=StatusCode.OK.value)
