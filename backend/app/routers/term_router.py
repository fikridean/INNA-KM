...
@router.post('/create', response_model=TermStoreResponseModel, status_code=StatusCode.CREATED.value)
async def create_term_route_func(params: TermStoreModel):
    try:
        data = await store_raw_to_terms(params)
        return success_response(data, message=ResponseMessage.OK_CREATEORUPDATE.value, status_code=StatusCode.OK.value)
    
    except Exception as e:
        return handleError(e)

# Get all terms
@router.post('/get', response_model=TermGetResponseModel, status_code=StatusCode.OK.value)
...
# Delete term
@router.delete('/delete', response_model=TermDeleteResponseModel, status_code=StatusCode.OK.value)
...
# Search terms
@router.post('/search', response_model=searchResponseModel, status_code=StatusCode.OK.value)
...
# Create indexes
@router.get('/create-indexes', status_code=StatusCode.OK.value)
