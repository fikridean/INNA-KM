...
from models.taxon_model import TaxonBaseModel, TaxonBaseResponseModel, TaxonBaseResponseModelObject, TaxonDeleteModel, TaxonGetDetailModel, TaxonGetDetailResponseModel, TaxonGetModel, TaxonGetResponseModel, TaxonGetResponseModelObject
from services.taxon_service import create_taxon, delete_taxon, get_taxon, get_taxon_details
...
@router.post('/create', response_model=List[TaxonBaseResponseModel], status_code=StatusCode.CREATED.value)
...
# Get all taxa
@router.post('/get', response_model=List[TaxonGetResponseModel], status_code=StatusCode.OK.value)
...
# Get taxon details
@router.get('/detail', response_model=TaxonGetDetailResponseModel, status_code=StatusCode.OK.value)
...
# Delete taxon
@router.delete('/delete', response_model=TaxonBaseResponseModel, status_code=StatusCode.OK.value)
